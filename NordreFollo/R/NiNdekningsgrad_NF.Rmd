...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'Tilstand_NaturtyperMdir_NordreFollo.html'))})
---
...
## ELC10
Zander sent em a cropped file. The full tile is in the same folder, but called ELC10_2018_NF_fullTile.
```{r}
