...
```{r}
png("../output/indicatorPlots/snødybde tiddserie.png", 
    units="in", width=5, height=12, res=300)
gg
dev.off()
```
![](../output/indicatorPlots/snødybde tiddserie.png)

Stiplalinja er 2sd under forrige normalperioden.
Her er det ikke så mye å spore i form av trender.
...
png("../output/indicatorPlots/snødybde tiddserie versjon 2.png", 
    units="in", width=12, height=7, res=300)  
  
 # Plot for region = 'Norge'
  plot(
    Norge$diff~Norge$year, 
    ylab="Snødekkets varighet (dagers avvik fra 1961-1990)",
    xlab="",
    main="",
...
png("../output/indicatorPlots/snødybde_boxplot.png", 
    units="in", width=5, height=7, res=300)
myPlot
dev.off()
```
![](../output/indicatorPlots/snødybde_boxplot.png)
