...
for (j in 1:length(regions)){
    ...
    abline(v=(length(unique(allind$X))-3)+0.5, col="black", lwd=2)
    abline(v=(length(unique(allind$X))-3)+1.5, col="grey", lwd=1, lty=2)
    abline(v=(length(unique(allind$X))-3)+2.5, col="black", lwd=2)
