...
### Temperatur
[Klikk her](temperatur.html) for mer informasjon.
<br>

### Vekstsesong
[Klikk her](vekstsesong.html) for mer informasjon.
...
### Fugler i fjellet
Dette er en supplerende variabl/indikator som viser tilstanden/utviklingen til fem, vanlige alpine fuglearter. Indikatoren er ikke med i hovedindikatorsettet siden datagrunnlaget overlapper i stor grad med naturindeksen for fjell. ![](../figures/magnifyingglas.png){width=1cm}[Klikk her](https://ninanor.github.io/IBECA/fuglerifjellet.html) for å se tekniske detaljer analysene.
<br>

### Trofiske grupper i Naturindeks for fjell
[Dette er en inndeling av indikatorene i fjellindeksen i trofiske grupper.](trofiske_grupper.html)
...
### Nitrogen
En tidsserie for [N nedfall i fjellet](nitrogen.html).
...
Her er et utakt til en sjekkliste som var ment å fylles ut for hver indikator. Det ble ikke brukt.
