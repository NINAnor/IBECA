...
## Importerer data
Det er fire datasett - breatlaset, 50, regioninndelingen, og omriss av Norge.
Vi trenger ikke fjellmasker da vi kan anta at alle isebreer ligger i fjellet.
...
Alt 1 er nok ikke særlig bra. 
Alt 2 kan forsvares.
Alt 3 er nok ikke særlig bra.
Alt 4 kan forsvares og ligner veldig på hvordan NI kalkuleres. 

Alt 2 sier 'hvordan er den TOTALE ENDRINGEN i breareal i norge sett under ett'.
Alt 4 sier 'hvordan er den GJENNOMSNITTLIGE endringen i breareal i i de ulike regionene i Norge.
