...
Her simulerer jeg indicatorverdier 10000 ganger per år.
```{r}
...
Jeg slår sammen de relevnte rovviltregionene til ØT regioner. Jeg inkluderer alle rovviltregioner sopm overlapper med den respektive ØTregionen.
...
indicator_plot(dataset = jervTbl,
...
Under er tabellen med skalerte verdier for hvert år og regoin (med = median, og det er det som er 'tilstanden')
