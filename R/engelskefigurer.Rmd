...
temp_names$plot <- c("Absence of alien species ", 
                     ...
                     "Biomass composition across trophic levels",
...
for (i in 1:length(periods)){
  for (j in 1:length(regions)){
    ...
    png(paste("../output/aggregated_plots/englishPlots/region_", regions[j],"_",temp_per, ".png", sep=""), units="in", width=8, height=14, res=600)
...
for (i in 1:length(periods)){
  for (j in 1:length(regions)){
    ...
    png(paste("../output/aggregated_plots/englishPlots/pressures_region_", regions[j],"_",temp_per, ".png", sep=""), units="in", width=4, height=11, res=600)
...
for (i in 1:length(periods)){
  ...
  png(paste("../output/aggregated_plots/englishPlots/comb_", temp_per, ".png", sep=""), units="in", width=6, height=11, res=600)
