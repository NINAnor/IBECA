...
par(mfrow=c(1,2))
plot(fjellc10cv3, main = "Aggregation with threshold")
  plot(datcc$geometry[datcc$andelFjell<0.2], add=T, col = heat.colors(datcc$andelFjell*10, alpha=.5))
plot(fjellc10cv3, main = "Aggregation with threshold")
  plot(datcc$geometry[datcc$andelFjell>0.8], add=T, col = heat.colors(datcc$andelFjell*10, alpha=.5))


```
Dette differensierer territoriene etter hvor mye fjell de innehar. Vi kan 
