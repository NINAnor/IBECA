...
# Rasterstack directory; 
RasterLocation <- paste("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/Klima/Days Snow Cover/", paste(paste("sd_s", uniq_y[1], uniq_y[length(uniq_y)], sep = "_"),".grd", sep = ""), sep = "")
...
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
  ...
  # Rasterstack directory
  RasterLocation = paste("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/Klima/Vinterregn/", paste(paste("sd_gw", uniq_y[1], uniq_y[length(uniq_y)], sep = "_"), ".grd", sep = ""), sep = "")
...
test = stack("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/Klima/Dager med nedbør/rr_days_1957_2020.grd")
newCRS = crs(mountCount_region2_full)
crs(test) = newCRS
writeRaster(test, "P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/Klima/Dager med nedbør/testDays.grd", format = "GTiff")
writeRaster(sPrecipForCount_region1, RasterLocation_r1, format = "raster", overwrite = TRUE)
...
var infra_epsg = ee.Image("users/markusfisraelsen/Infra_ESPG25833"),
    ecosystem_map = ee.Image("users/zandersamuel/NINA/Raster/Norway_ecosystem_types_Simon_5m"),
    regnorway_wgs84 = ee.FeatureCollection("users/tsimonjakobsson/ecocond_2020-2021/regNorway_wgs84"),
    daysPrecip = ee.Image("users/markusfisraelsen/daysPrecip"),
...
var infra_projection = infra_viz.projection();
var ecosystem_projection = ecosystem_map.projection();
var daysPrecip_projection = daysPrecip.projection(); // This projection is used for all climate variables
...
var daysPrecip_region1 = daysPrecip.clip(region1_geo);
var daysPrecip_region2 = daysPrecip.clip(region2_geo);
var daysPrecip_region3 = daysPrecip.clip(region3_geo);
var daysPrecip_region4 = daysPrecip.clip(region4_geo);
var daysPrecip_region5 = daysPrecip.clip(region5_geo);

// Clip daysSnowCover for each region
var daysSnowCover_region1 = daysSnowCover.clip(region1_geo);
var daysSnowCover_region2 = daysSnowCover.clip(region2_geo);
var daysSnowCover_region3 = daysSnowCover.clip(region3_geo);
var daysSnowCover_region4 = daysSnowCover.clip(region4_geo);
var daysSnowCover_region5 = daysSnowCover.clip(region5_geo);

// Clip daysSnowCoverTemp for each region
var daysSnowTemp_region1 = daysSnowTemp.clip(region1_geo);
var daysSnowTemp_region2 = daysSnowTemp.clip(region2_geo);
var daysSnowTemp_region3 = daysSnowTemp.clip(region3_geo);
var daysSnowTemp_region4 = daysSnowTemp.clip(region4_geo);
var daysSnowTemp_region5 = daysSnowTemp.clip(region5_geo);

// Clip growth season for each region
var growthSeason_region1 = growthSeason.clip(region1_geo);
var growthSeason_region2 = growthSeason.clip(region2_geo);
var growthSeason_region3 = growthSeason.clip(region3_geo);
var growthSeason_region4 = growthSeason.clip(region4_geo);
var growthSeason_region5 = growthSeason.clip(region5_geo);


// Clip mean summer temperature for each region
var meanSummer_region1 = meanSummer.clip(region1_geo);
var meanSummer_region2 = meanSummer.clip(region2_geo);
var meanSummer_region3 = meanSummer.clip(region3_geo);
var meanSummer_region4 = meanSummer.clip(region4_geo);
var meanSummer_region5 = meanSummer.clip(region5_geo);

// Clip mean winter temperature for each region
var meanWinter_region1 = meanWinter.clip(region1_geo);
var meanWinter_region2 = meanWinter.clip(region2_geo);
var meanWinter_region3 = meanWinter.clip(region3_geo);
var meanWinter_region4 = meanWinter.clip(region4_geo);
var meanWinter_region5 = meanWinter.clip(region5_geo);
*/
...
// Export the climate variables for each region (Every variable was exported as the one shown below)
Export.image.toDrive({
...
Export.image.toDrive({
  ...
  crs: Mount_sumPrecip_projection,
  maxPixels: 1e10
});
...
# Mountain Count
mountCount_region1_full = raster("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/GEE/mountInfra/mount_infra_region1.tif", band = 2)
mountCount_region2_full = raster("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/GEE/mountInfra/mount_infra_region2.tif", band = 2)
mountCount_region3_full = raster("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/GEE/mountInfra/mount_infra_region3.tif", band = 2)
mountCount_region4_full = raster("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/GEE/mountInfra/mount_infra_region4.tif", band = 2)
mountCount_region5_full = raster("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/GEE/mountInfra/mount_infra_region5.tif", band = 2)
...
# Clip mountain count to the days precip shapefile
mountCount_region1 = crop(mountCount_region1_full, daysShp_region1)
mountCount_region2 = crop(mountCount_region2_full, sumShp_region2)
mountCount_region3 = crop(mountCount_region3_full, daysShp_region3)
mountCount_region4 = crop(mountCount_region4_full, daysShp_region4)
mountCount_region5 = crop(mountCount_region5_full, daysShp_region5)
...
RasterDir_sumPrecip_r2 = paste("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/Klima/Sum nedbør/", paste(paste("sumPrecipMountCount_region2", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")

# Export the rasters
writeRaster(sumPrecipMountCount_region2, RasterDir_sumPrecip_r2, format = "raster", overwrite = TRUE)



# 
# # Sum precipitation region 1
...
# 
# # Sum precipitation region 2
# sumPrecip_region2 = list.files("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/Klima/Sum nedbør/", full.names = TRUE, pattern = "region2.tif$")
# sumPrecip_region2 = stack(sumPrecip_region2) 
# 
# # Sum precipitation region 3
# sumPrecip_region3 = list.files("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum precipitation/", full.names = TRUE, pattern = "region3.tif$")
# sumPrecip_region3 = stack(sumPrecip_region3) 
# 
# # Sum precipitation region 4
# sumPrecip_region4 = list.files("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum precipitation/", full.names = TRUE, pattern = "region4.tif$")
# sumPrecip_region4 = stack(sumPrecip_region4) 
# 
# # Sum precipitation region 5
# sumPrecip_region5 = list.files("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum precipitation/", full.names = TRUE, pattern = "region5.tif$")
# sumPrecip_region5 = stack(sumPrecip_region5) 
# 
# 
# # Add forest count to Sum precipitation region 1
# sPrecipForCount_region1 = addLayer(sumPrecip_region1, forCount_region1_red) 
# names(sPrecipForCount_region1) = c("1957":"2020", "forCount") 
# 
# # Add forest count to Sum precipitation region 2 
# sPrecipForCount_region2 = addLayer(sumPrecip_region2, fCount_region2_red) 
# names(sPrecipForCount_region2) = c("1957":"2020", "forCount") 
# 
# # Add forest count to Sum precipitation region 3
# sPrecipForCount_region3 = addLayer(sumPrecip_region3, fCount_region3_red) 
# names(sPrecipForCount_region3) = c("1957":"2020", "forCount") 
# 
# # Add forest count to Sum precipitation region 4
# sPrecipForCount_region4 = addLayer(sumPrecip_region4, forCount_region4_red) 
# names(sPrecipForCount_region4) = c("1957":"2020", "forCount") 
# 
# # Add forest count to day snow cover region 5
# sPrecipForCount_region5 = addLayer(sumPrecip_region5, forCount_region5_red) 
# names(sPrecipForCount_region5) = c("1957":"2020", "forCount") 
# 
# # Export the raster
# RasterLocation_r1 = paste("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum Precipitation/sumPrecipForestCount/", paste(paste("sPrecipForCount_region1", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")
# 
# RasterLocation_r2 = paste("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum Precipitation/sumPrecipForestCount/", paste(paste("sPrecipForCount_region2", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")
# 
# RasterLocation_r3 = paste("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum Precipitation/sumPrecipForestCount/", paste(paste("sPrecipForCount_region3", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")
# 
# RasterLocation_r4 = paste("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum Precipitation/sumPrecipForestCount/", paste(paste("sPrecipForCount_region4", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")
# 
# RasterLocation_r5 = paste("/data/P-Prosjekter/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Sum Precipitation/sumPrecipForestCount/", paste(paste("sPrecipForCount_region5", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")
# 
# # Write Raster
# writeRaster(sPrecipForCount_region1, RasterLocation_r1, format = "raster", overwrite = TRUE)
# writeRaster(sPrecipForCount_region2, RasterLocation_r2, format = "raster", overwrite = TRUE)
# writeRaster(sPrecipForCount_region3, RasterLocation_r3, format = "raster", overwrite = TRUE)
# writeRaster(sPrecipForCount_region4, RasterLocation_r4, format = "raster", overwrite = TRUE)
# writeRaster(sPrecipForCount_region5, RasterLocation_r5, format = "raster", overwrite = TRUE)
...
daysPrecip_region1 = list.files("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Days Precipitation/", full.names = TRUE, pattern = "region1.tif$")
daysPrecip_region1 = stack(daysPrecip_region1) 
daysExtent_region1 = extent(daysPrecip_region1) # Get the extent of days precip region 1
daysShp_region1 = as(daysExtent_region1, "SpatialPolygons") # create a shapefile of the extent of days precip region1
crs(daysShp_region1) = crs(daysPrecip_region1) # set the crs

# Days precipitation region 2 1957 - 2020
daysPrecip_region2 = list.files("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Days Precipitation/", full.names = TRUE, pattern = "region2.tif$")
daysPrecip_region2 = stack(daysPrecip_region2) 
daysExtent_region2 = extent(daysPrecip_region2) 
daysShp_region2 = as(daysExtent_region2, "SpatialPolygons") 
crs(daysShp_region2) = crs(daysPrecip_region2) 

# Days precipitation region 3 1957 - 2020
daysPrecip_region3 = list.files("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Days Precipitation/", full.names = TRUE, pattern = "region3.tif$")
daysPrecip_region3 = stack(daysPrecip_region3) 
daysExtent_region3 = extent(daysPrecip_region3) 
daysShp_region3 = as(daysExtent_region3, "SpatialPolygons") 
crs(daysShp_region3) = crs(daysPrecip_region3) 

# Days precipitation region 4 1957 - 2020
daysPrecip_region4 = list.files("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Days Precipitation/", full.names = TRUE, pattern = "region4.tif$")
daysPrecip_region4 = stack(daysPrecip_region4) 
daysExtent_region4 = extent(daysPrecip_region4) 
daysShp_region4 = as(daysExtent_region4, "SpatialPolygons") 
crs(daysShp_region4) = crs(daysPrecip_region4) 

# Days precipitation region 5 1957 - 2020
daysPrecip_region5 = list.files("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/M/Klima/All years 1957 - 2020/Days Precipitation/", full.names = TRUE, pattern = "region5.tif$")
daysPrecip_region5 = stack(daysPrecip_region5) 
daysExtent_region5 = extent(daysPrecip_region5)
daysShp_region5 = as(daysExtent_region5, "SpatialPolygons")
crs(daysShp_region5) = crs(daysPrecip_region5) 

# Clip mountain count to the days precip shapefile
mountCount_region1 = crop(mountCount_region1_full, daysShp_region1)
mountCount_region2 = crop(mountCount_region2_full, daysShp_region2)
mountCount_region3 = crop(mountCount_region3_full, daysShp_region3)
mountCount_region4 = crop(mountCount_region4_full, daysShp_region4)
mountCount_region5 = crop(mountCount_region5_full, daysShp_region5)

# Reduce mountain count (100 x 100m) to daysPrecip (1000 x 1000m). 
mountCount_region1_red = raster::aggregate(mountCount_region1, fact = 10, fun = sum) # Reduce mountain count by a factor of 10, and sum the pixels (seems to be correct)
extent(mountCount_region1_red) = extent(daysPrecip_region1) # Set the extent of mountain count to that of days precip region 1
dPrecipMountCount_region1 = addLayer(daysPrecip_region1, mountCount_region1_red) # add mountain count to days precip
names(dPrecipMountCount_region1) = c("1957":"2020", "mountCount") # rename the layers

# Reduce mountain count (100 x 100m) to daysPrecip (1000 x 1000m). 
mountCount_region2_red = raster::aggregate(mountCount_region2, fact = 10, fun = sum)
extent(mountCount_region2_red) = extent(daysPrecip_region2)
fCount_region2_red = resample(mountCount_region2_red, daysPrecip_region2, method = "ngb") # Had to resample because forest count had one column too few
dPrecipMountCount_region2 = addLayer(daysPrecip_region2, fCount_region2_red) 
names(dPrecipMountCount_region2) = c("1957":"2020", "mountCount") 

# Reduce mountain count (100 x 100m) to daysPrecip (1000 x 1000m). 
mountCount_region3_red = raster::aggregate(mountCount_region3, fact = 10, fun = sum) 
extent(mountCount_region3_red) = extent(daysPrecip_region3) 
fCount_region3_red = resample(mountCount_region3_red, daysPrecip_region3, method = "ngb") # Had to resample because forest count had one column too few
dPrecipMountCount_region3 = addLayer(daysPrecip_region3, fCount_region3_red) 
names(dPrecipMountCount_region3) = c("1957":"2020", "mountCount") 

# Reduce mountain count (100 x 100m) to daysPrecip (1000 x 1000m). 
mountCount_region4_red = raster::aggregate(mountCount_region4, fact = 10, fun = sum) 
extent(mountCount_region4_red) = extent(daysPrecip_region4) 
dPrecipMountCount_region4 = addLayer(daysPrecip_region4, mountCount_region4_red) 
names(dPrecipMountCount_region4) = c("1957":"2020", "mountCount") 

# Reduce mountain count (100 x 100m) to daysPrecip (1000 x 1000m). 
mountCount_region5_red = raster::aggregate(mountCount_region5, fact = 10, fun = sum) 
extent(mountCount_region5_red) = extent(daysPrecip_region5) 
dPrecipMountCount_region5 = addLayer(daysPrecip_region5, mountCount_region5_red) 
names(dPrecipMountCount_region5) = c("1957":"2020", "mountCount") 

# Export the raster
RasterLocation_r1 = paste("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/3 - mountCount to Climate/", paste(paste("dPrecipMountCount_region1", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")

RasterLocation_r2 = paste("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/3 - mountCount to Climate/", paste(paste("dPrecipMountCount_region2", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")

RasterLocation_r3 = paste("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/3 - mountCount to Climate/", paste(paste("dPrecipMountCount_region3", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")

RasterLocation_r4 = paste("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/3 - mountCount to Climate/", paste(paste("dPrecipMountCount_region4", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")

RasterLocation_r5 = paste("P:/41201042_okologisk_tilstand_fastlandsnorge_2020_dataanaly/fjell2021/data/3 - mountCount to Climate/", paste(paste("dPrecipMountCount_region5", 1957, 2020, sep = "_"), ".grd", sep = ""), sep = "")

# # Write Raster
# writeRaster(dPrecipMountCount_region1, RasterLocation_r1, format = "raster", overwrite = TRUE)
writeRaster(dPrecipMountCount_region2, RasterLocation_r2, format = "raster", overwrite = TRUE)
writeRaster(dPrecipMountCount_region3, RasterLocation_r3, format = "raster", overwrite = TRUE)
writeRaster(dPrecipMountCount_region4, RasterLocation_r4, format = "raster", overwrite = TRUE)
writeRaster(dPrecipMountCount_region5, RasterLocation_r5, format = "raster", overwrite = TRUE)

```

### 5.3 Beregne antall fjellpixler i hver "daysSnowCover" rasterpixel for hver region og slå de to lagene sammen til en raster 
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
...
### 5.4 Beregne antall fjellpixler i hver "growthSeason" rasterpixel for hver region og slå de to lagene sammen til en raster
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
...
### 5.5 Beregne antall fjellpixler i hver "meanSummer" rasterpixel for hver region og slå de to lagene sammen til en raster
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
...
### 5.6 Beregne antall fjellpixler i hver "meanWinter" rasterpixel for hver region og slå de to lagene sammen til en raster
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
