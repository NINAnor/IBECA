...
### 6.1 Differanse fra normalperioden for sum nedbør
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
...
### 6.5 Bootstrapping for å finne variasjonen i differansen mellom nåværende periode og normalperioden for snødekke
Det trekkes ut et tilfeldig år i normalperioden og et tilfeldig år i nåværende periode (2016-2020), finner medianen for hver, og trekker medianen i normalperioden fra medianen i nåværende periode. Dette gjentas så 10 000 ganger.
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
# Load data
...
### 6.6 Bootstrapping for å finne variasjonen i differansen mellom nåværende periode og normalperioden for vekstsesong
Det trekkes ut et tilfeldig år i normalperioden og et tilfeldig år i nåværende periode (2016-2020), finner medianen for hver, og trekker medianen i normalperioden fra medianen i nåværende periode. Dette gjentas så 10 000 ganger.
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
# Load data
...
### 6.7 Bootstrapping for å finne variasjonen i differansen mellom nåværende periode og normalperioden for vinterregn
Det trekkes ut et tilfeldig år i normalperioden og et tilfeldig år i nåværende periode (2016-2020), finner medianen for hver, og trekker medianen i normalperioden fra medianen i nåværende periode. Dette gjentas så 10 000 ganger.
```{r, echo = TRUE, warnings = FALSE, message = FALSE, eval = FALSE}
# Load data
